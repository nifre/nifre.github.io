...
Per la realizzazione di questo progetto sono stati utilizzati **(modelli linguistici di tipo LLM )** come supporto allo sviluppo e alla redazione dei contenuti.  
In particolare:
- Le **biografie** e parti descrittive  e successivamente verificate e adattate manualmente.  
- Alcune porzioni di **codice JavaScript** sono state sviluppate con il supporto di LLM e di siti di documentazione.  
- Tutti i file sono stati poi **modificati, integrati e verificati autonomamente** per garantire coerenza, correttezza e conformità ai requisiti d’esame.  
...
Un elemento in ogni pagina (ad esempio il titolo `<h2>`) presenta uno stile ridefinito inline tramite l’attributo `style`
---
